...
import { ExternalLink, Activity, Zap, Database, Code, Brain } from 'lucide-react'

// เพิ่ม icon ประจำตำแหน่งเพื่อให้ดูมีมิติมากขึ้น
const members = [
    { id: 'phruk', name: 'Phruk', role: 'AI Engineer', short: 'AI ENG', icon: Brain },
    { id: 'poom', name: 'Poom', role: 'Frontend Developer', short: 'FRONTEND', icon: Code },
    { id: 'boss', name: 'Boss', role: 'Backend Developer', short: 'BACKEND', icon: Database },
    { id: 'nut', name: 'Nut', role: 'Data Scientist', short: 'DATA SCI', icon: Zap },
]
...
export default function Footer({ setPage }) {
    return (
        <footer className="relative z-20 mt-32 pb-12 px-4 md:px-6 overflow-hidden">
            ...
            {/* ─── BOTTOM COPYRIGHT BAR (UPDATED: Bigger & Clearer) ─── */}
